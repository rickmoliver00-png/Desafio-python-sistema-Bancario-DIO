...
def menu():
    menu = """\n
    =============== BANCO RMO ================
     Escolha a opção que deseja no menu abaixo
...
def depositar(saldo, valor, extrato, /):
    if valor > 0:
        ...
        print("\n@@@ ⚠️ Operação cancelada! O valor informado é inválido. @@@")
...
def sacar(*, saldo, valor, extrato, limite, numero_saques, limite_saques):
    ...
    if excedeu_saldo:
        print("\n@@@ ⚠️ Operação falhou! Você não possui saldo suficiente. @@@")
...
def main():
    ...
    while True:
        ...
        if opcao == "d":
            ...
            print("⚠️Operação inválida, por favor selecione novamente a opção desejada.")
